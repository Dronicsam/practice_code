  ...
  const onResults = (results: any) => {
    ...
    if (results.poseLandmarks) {
      ...
      if (
        ...
        if (
          rightHandCoords.current[8]["x"] <= 0.95 &&
          0.65 <= rightHandCoords.current[8]["x"] &&
          rightHandCoords.current[8]["y"] <= 0.7 &&
          0.65 <= rightHandCoords.current[8]["y"]
        ) {
        ...
        if (
          regimeRightNow == "" &&
          rightHandCoords.current[8]["x"] <= 0.35 &&
          0.05 <= rightHandCoords.current[8]["x"] &&
          rightHandCoords.current[8]["y"] <= 0.7 &&
          0.65 <= rightHandCoords.current[8]["y"]
        ) {
      ...
      if (
        ...
        if (
          regime == "" &&
          leftHandCoords.current[8]["x"] <= 0.95 &&
          0.65 <= leftHandCoords.current[8]["x"] &&
          leftHandCoords.current[8]["y"] <= 0.7 &&
          0.65 <= leftHandCoords.current[8]["y"]
        ) {
          regimeRightNow = "Обучение";
          setRegime("Обучение");
        }
        ...
        if (
          regimeRightNow == "" &&
          leftHandCoords.current[8]["x"] <= 0.35 &&
          0.05 <= leftHandCoords.current[8]["x"] &&
          leftHandCoords.current[8]["y"] <= 0.7 &&
          0.65 <= leftHandCoords.current[8]["y"]
        ) {
          regimeRightNow = "Тестирование";
